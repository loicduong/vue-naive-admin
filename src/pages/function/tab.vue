...
<template>
  <NSpace vertical :size="16">
    ...
    >
      ...
      <NButton @click="routerPushByKey('/about')">
        {{ $t('page.function.tab.tabOperate.addTabDesc') }}
      </NButton>
      <NDivider title-placement="left">
        {{ $t('page.function.tab.tabOperate.closeTab') }}
      </NDivider>
      <NSpace>
      ...
      <NSpace>
        <NButton @click="routerPushByKey('/function/multi-tab')">
          {{ $t('page.function.tab.tabOperate.addMultiTabDesc1') }}
        </NButton>
        <NButton @click="routerPushByKey('/function/multi-tab', { query: { a: '1' } })">
