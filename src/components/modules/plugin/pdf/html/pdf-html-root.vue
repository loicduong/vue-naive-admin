...
<template>
  <div class="paged-root">
    ...
    <p>
      ...
      <a href="#fred">go to Fred</a> whenever it is a damp, drizzly November in
      ...
      for pistol and ball. With a philosophical flourish Cato throws himself
    ...
    <p>
      ...
      which a few hours previous were out of sight of land. Look at the crowds
    ...
    <p>
      ...
      striving to get a still better seaward peep. But these are all landsmen;
      of week days pent up in lath and plaster—tied to counters, nailed to
      benches, clinched to desks. How then is this? Are the green fields gone?
      What do they here?
    </p>
    ...
    <p>
      ...
      knee-deep among Tiger-lilies—what is the one charm wanting?—Water—there is
      ...
      robust healthy soul in him, at some time or other crazy to go to sea? Why
      upon your first voyage as a passenger, did you yourself feel such a
      mystical vibration, when first told that you and your ship were now out of
      sight of land? Why did the old Persians hold the sea holy? Why did the
    ...
    <p>
      ...
      For my part, I abominate all honourable respectable toils, trials, and
      ...
      is considerable glory in that, a cook being a sort of officer on
    ...
    <p>
      ...
      about—however they may thump and punch me about, I have the satisfaction
      of knowing that it is all right; that everybody else is one way or other
      served in much the same way—either in a physical or metaphysical point of
      view, that is; and so the universal thump is passed round, and all hands
    ...
    <p>
      ...
      me, and influences me in some unaccountable way—he can better answer than
      any one else. And, doubtless, my going on this whaling voyage, formed part
      of the grand programme of Providence that was drawn up a long time ago. It
    ...
    <p>“BLOODY BATTLE IN AFFGHANISTAN.”</p>
    <p>
      ...
      why this was exactly; yet, now that I recall all the circumstances, I
